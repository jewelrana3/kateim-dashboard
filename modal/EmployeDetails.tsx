      ...
      <DialogContent className="sm:max-w-[900px]">
        <div className="bg-white p-5 flex flex-col md:flex-row gap-6 items-start">
          ...
          <div className="flex-1 space-y-2 text-gray-800">
            ...
            <p>
              <span className="font-semibold">Status</span> : {user.isAccountVerified ? <span className="text-green-600">Verified</span> : <span className="text-red-600">Not Verified</span>}
            </p>
